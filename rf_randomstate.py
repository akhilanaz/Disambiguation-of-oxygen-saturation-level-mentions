...
for i, random_state in enumerate(random_states):
    ...
    rf_classifier  = RandomForestClassifier(max_features=300)
    ...
    results_df.to_csv(f'new_rf_grid_search_randomsplit{random_state}.csv', index=False)
    ...
    current_best_params = grid_search_rf.best_params_
    ...
    if precision > best_precision:
        ...
        # Train RF model with the best parameters for the current iteration
...
metrics_df.to_csv('new_rf_metrics_scores.csv', index=False)
...
# Print the results
print(f'Precision: Mean={mean_precision}, Std={std_precision}, St_error= {std_precision/math.sqrt(10)}, CI={lower_bound_precision,upper_bound_precision }')
print(f'Recall: Mean={mean_recall}, Std={std_recall}, St_error= {std_recall/math.sqrt(10)}, CI={lower_bound_recall,upper_bound_recall }')
print(f'F1 Score: Mean={mean_f1}, Std={std_f1}, St_error= {std_f1/math.sqrt(10)}, CI={lower_bound_f1_score,upper_bound_f1_score }')
